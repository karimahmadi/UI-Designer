...
(function (window, undefined) {
    ...
    var Keycloak = function (config) {
        ...
        //by kheradmandian
        kc.reloadHomePage = function(options) {
            return adapter.reloadHomePage(options);
        };
        ...
        //by kheradmandian
        kc.createReloadHomePageUrl = function (options) {
            var url = kc.endpoints.reloadHomePage();
            return url;
        };
                ...
                if (!oidcConfiguration) {
                    kc.endpoints = {
                        ...
                        reloadHomePage: function () {
                            var res,src= getRealmUrl();
                                res=src.replace('auth/realms/Test-Realm','#/home');
                            return res;
                        },
        ...
        function loadAdapter(type) {
            if (!type || type == 'default') {
                return {
                    ...
                    //by kheradmandian
                    reloadHomePage: function (options) {
                        window.location.replace(kc.createReloadHomePageUrl(options));
                        return createPromise().promise;
                    },
